...
export const HowDoesThisWorkModal: React.FC<HowDoesThisWorkModalProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  const t = dictionary.howDoesThisWorkModal;
  ...
  const steps = [
    ...
    { num: '4', title: t.steps.step4Title, desc: t.steps.step4Desc },
    { num: '5', title: t.steps.step5Title, desc: t.steps.step5Desc },
    { num: '6', title: t.steps.step6Title, desc: t.steps.step6Desc },
  ];
      ...
      >
        ...
        <div className="p-5 overflow-y-auto space-y-4 text-slate-700 dark:text-slate-300 text-xs">
          ...
          <div className="p-3.5 bg-slate-900 dark:bg-slate-950 text-white rounded-lg space-y-1 shadow-xs border border-slate-800">
            ...
            <p className="font-semibold text-slate-100 text-xs pt-0.5">
              “{t.coreRuleText}”
            </p>
          </div>

          {/* Numbered 6-Step Execution Flow */}
