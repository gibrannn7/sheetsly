    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200 bg-slate-50">
          <div>
            <h3 id="smart-generate-modal-title" className="text-sm font-bold text-slate-900 uppercase tracking-wide">
              {t.title}
            </h3>
        ...
        <div className="p-5 overflow-y-auto space-y-4 text-slate-700 text-xs">
          ...
          <div className="p-3 rounded-lg border border-slate-200 bg-slate-50 text-[11px] text-slate-600 leading-relaxed">
            <span className="font-semibold text-slate-800">Analytical Principle: </span>
            {t.footerNote}
          </div>
        </div>
