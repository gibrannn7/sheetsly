...
export const ActualDataViewer: React.FC<ActualDataViewerProps> = ({ datasetId, sheetName }) => {
  ...
  // Fetch paginated grid slice whenever sheet, page, or pageSize changes
  useEffect(() => {
    let isMounted = true;
    setIsLoading(true);
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-1.5 text-xs text-slate-600">
              ...
              <select
                ...
                className="bg-white border border-slate-300 rounded px-2 py-0.5 text-xs font-mono font-medium text-slate-800 focus:outline-hidden focus:ring-1 focus:ring-slate-900 cursor-pointer"
              >
            ...
            {gridData && totalRows > 0 && (
              <div className="text-[11px] text-slate-600 font-mono tabular-nums bg-white border border-slate-200 px-2 py-0.5 rounded">
