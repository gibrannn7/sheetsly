...
export const AnalysisBuilderHelpModal: React.FC<AnalysisBuilderHelpModalProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  const modalContent = (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="builder-help-modal-title"
    >
      <div
        ref={modalRef}
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 transition-colors">
          <div>
            <h3 id="builder-help-modal-title" className="text-sm font-bold text-slate-900 dark:text-slate-100 uppercase tracking-wide">
              {t.title}
            </h3>
