...
import { SmartAnalyticsHelpModal } from './SmartAnalyticsHelpModal';
...
export const SmartVisualizationPanel: React.FC<SmartVisualizationPanelProps> = ({
  ...
  const quickPrompts = [
    dictionary.smartAnalytics.quickPrompts.monthlyTrend,
    dictionary.smartAnalytics.quickPrompts.categoryComparison,
    dictionary.smartAnalytics.quickPrompts.top5Products,
    dictionary.smartAnalytics.quickPrompts.salesProfitCorrelation,
  ];
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-4 shadow-2xs space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-200">
                {dictionary.smartAnalytics.title}
              </h3>
              <button
                type="button"
                ...
                title={dictionary.smartAnalytics.howItWorksBtn}
              >
                ...
                <span>{dictionary.smartAnalytics.howItWorksBtn}</span>
              </button>
            </div>
            <span className="text-[10px] font-mono font-medium px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
              {dictionary.smartAnalytics.evidenceBadge}
            </span>
          </div>
          ...
          >
            <input
              ...
              placeholder={dictionary.smartAnalytics.inputPlaceholder}
            ...
            >
              {isLoading ? dictionary.smartAnalytics.analyzingBtn : dictionary.smartAnalytics.visualizeBtn}
            </button>
          </form>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-4 shadow-2xs space-y-3 text-xs">
              <div className="border-b border-slate-200 dark:border-slate-800 pb-2 flex items-center justify-between">
                <h5 className="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider text-[11px]">
                  {dictionary.smartAnalytics.dataProvenance}
                </h5>
              </div>

              <div className="space-y-2 text-[11px]">
                <div>
                  <span className="text-slate-500 block text-[10px] uppercase font-bold">{dictionary.smartAnalytics.sourceSheets}</span>
                ...
                <div>
                  <span className="text-slate-500 block text-[10px] uppercase font-bold">{dictionary.smartAnalytics.sourceColumns}</span>
                  <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">
                ...
                <div>
                  <span className="text-slate-500 block text-[10px] uppercase font-bold">{dictionary.smartAnalytics.rangesSampled}</span>
                ...
                <div>
                  <span className="text-slate-500 block text-[10px] uppercase font-bold">{dictionary.smartAnalytics.aggregationMethod}</span>
                  <span className="font-mono font-semibold text-slate-800 dark:text-slate-200">
                ...
                <div className="pt-2 border-t border-slate-200 dark:border-slate-800">
                  <span className="inline-flex items-center gap-1.5 text-[10px] font-mono font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-2 py-1 rounded w-full justify-center">
